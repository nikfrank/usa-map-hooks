...
export default ({ mapColors={}, fallback='black', onClick })=>(
  <svg viewBox="0 0 959 593" onClick={onClick}>
    <path fill={mapColors.AK || fallback} id='AK'
    ...
    <path fill={mapColors.HI || fallback} id='HI'
    ...
    <path fill={mapColors.AL || fallback} id='AL'
    ...
    <path fill={mapColors.AR || fallback} id='AR'
    ...
    <path fill={mapColors.AZ || fallback} id='AZ'
    ...
    <path fill={mapColors.CA || fallback} id='CA'
    ...
    <path fill={mapColors.DE || fallback} id='DE'
    ...
    <path fill={mapColors.FL || fallback} id='FL'
    ...
    <path fill={mapColors.GA || fallback} id='GA'
    ...
    <path fill={mapColors.IA || fallback} id='IA'
    ...
    <path fill={mapColors.ID || fallback} id='ID'
    ...
    <path fill={mapColors.IL || fallback} id='IL'
    ...
    <path fill={mapColors.IN || fallback} id='IN'
    ...
    <path fill={mapColors.KS || fallback} id='KS'
    ...
    <path fill={mapColors.KY || fallback} id='KY'
    ...
    <path fill={mapColors.LA || fallback} id='LA'
    ...
    <path fill={mapColors.MA || fallback} id='MA'
    ...
    <path fill={mapColors.MD || fallback} id='MD'
    ...
    <path fill={mapColors.ME || fallback} id='ME'
    ...
    <path fill={mapColors.MI || fallback} id='MI'
    ...
    <path fill={mapColors.MN || fallback} id='MN'
    ...
    <path fill={mapColors.MO || fallback} id='MO'
    ...
    <path fill={mapColors.MS || fallback} id='MS'
    ...
    <path fill={mapColors.MT || fallback} id='MT'
    ...
    <path fill={mapColors.NC || fallback} id='NC'
    ...
    <path fill={mapColors.ND || fallback} id='ND'
    ...
    <path fill={mapColors.NE || fallback} id='NE'
    ...
    <path fill={mapColors.NH || fallback} id='NH'
    ...
    <path fill={mapColors.NJ || fallback} id='NJ'
    ...
    <path fill={mapColors.NM || fallback} id='NM'
    ...
    <path fill={mapColors.NV || fallback} id='NV'
    ...
    <path fill={mapColors.NY || fallback} id='NY'
    ...
    <path fill={mapColors.OH || fallback} id='OH'
    ...
    <path fill={mapColors.OK || fallback} id='OK'
    ...
    <path fill={mapColors.OR || fallback} id='OR'
    ...
    <path fill={mapColors.PA || fallback} id='PA'
    ...
    <path fill={mapColors.SD || fallback} id='SD'
    ...
    <path fill={mapColors.TN || fallback} id='TN'
    ...
    <path fill={mapColors.TX || fallback} id='TX'
    ...
    <path fill={mapColors.UT || fallback} id='UT'
    ...
    <path fill={mapColors.VA || fallback} id='VA'
    ...
    <path fill={mapColors.VT || fallback} id='VT'
    ...
    <path fill={mapColors.WA || fallback} id='WA'
    ...
    <path fill={mapColors.WI || fallback} id='WI'
    ...
    <path fill={mapColors.WV || fallback} id='WV'
